...
myimage = Image.open("Image/car.jpg")
...
obj_frame1=Frame(myroot,bg="#ceedd5")
obj_frame1.place(x=5,y=90,width=500,height=525)


#----------------Transmission label---------------
Transmissionl=Label(myroot,text='Transmission',fg='black',font='lucida 20 bold',bg="#ceedd5")
...
#----------------Fuel label---------------
Fuell=Label(myroot,text='Fuel',fg='black',font='lucida 20 bold',bg="#ceedd5")
...
#----------------Owner label---------------
Ownerl=Label(myroot,text='owner',fg='black',font='lucida 20 bold',bg="#ceedd5")
...
#----------------Seller label---------------
Seller_typel=Label(myroot,text='Seller type',fg='black',font='lucida 20 bold',bg="#ceedd5")
...
#----------------Seats label---------------
Seatsl=Label(myroot,text='Seats',fg='black',font='lucida 20 bold',bg="#ceedd5")
...
#----------------Engine label-----------------
Enginel=Label(myroot,text='Engine(cc)',fg='black',font='lucida 18 bold',bg="#ceedd5")
...
#----------------Power label-----------------
Powerl=Label(myroot,text='Power(bhp)',fg='black',font='lucida 18 bold',bg="#ceedd5")
...
#----------------Year label-----------------
Yearl=Label(myroot,text='Year',fg='black',font='lucida 18 bold',bg="#ceedd5")
...
#----------------mileage label-----------------
Mileagel=Label(myroot,text='Mileage(kmph)',fg='black',font='lucida 18 bold',bg="#ceedd5")
...
#----------------Km label-----------------
Km_drivenl=Label(myroot,text='Kilometers driven',font='lucida 18 bold',bg="#ceedd5")
...
#---------Predict Image-------------
myimage3 = Image.open("image/get-it-now-button.png")
...
#---------------Title label-----------
my_title = Label(myroot, text="Used Car Price prediction ", fg="white", bg="#F08080", font="lucida 25 bold ")
